...
function GenerateTable(cleaned) {
  ...
  var dateFirst = cleaned[0].match(regex);
  var dateLast = cleaned[rowCount-1].match(regex);

  dateFirst = new Date(dateFirst.groups.date);
  dateLast = new Date(dateLast.groups.date);
